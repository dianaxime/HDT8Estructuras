...
public class Main extends javax.swing.JFrame {
    VectorHeap<NodoPaciente> vector= new VectorHeap<>();
    /**
    ...
    private void initComponents() {
        ...
        jButton4.setText("Proximo paciente");
        ...
        try{
               // lee el archivo
                ...
                while (datos!=null){
                    ...
                    NodoPaciente paciente=new NodoPaciente( partes[0],partes[1],partes[2]);
                   vector.add(paciente);
                   datos= lector1.readLine();
                }
                 }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        if (vector.size()>0){
            jTextArea1.append(vector.remove().data() + "\n");
        }
